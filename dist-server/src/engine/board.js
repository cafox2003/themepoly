...
exports.isOwnable = exports.tileAt = exports.tileById = exports.ownableTiles = exports.BOARD = void 0;
const property = (index, id, label, group, price, rent, houseCost) => ({
    id,
    index,
...
exports.ownableTiles = exports.BOARD.filter((tile) => tile.kind === "property" || tile.kind === "railroad" || tile.kind === "utility");
const tileById = (tileId) => {
    const tile = exports.BOARD.find((candidate) => candidate.id === tileId);
    if (!tile)
        throw new Error(`Unknown tile ${tileId}`);
    return tile;
};
exports.tileById = tileById;
const tileAt = (position) => exports.BOARD[position % exports.BOARD.length];
exports.tileAt = tileAt;
const isOwnable = (tile) => tile.kind === "property" || tile.kind === "railroad" || tile.kind === "utility";
